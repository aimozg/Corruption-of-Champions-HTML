...
//Lust or HP loss texts here
    ...
    if (player.lowerBody == LowerBodyType.HOOFED) outputText("hocks and knees", false);
    ...
    if (player.vaginas.length > 0 && player.lowerBody != LowerBodyType.NAGA) outputText("slamming his twin dicks into your " + player.vaginaDescript(0) + " and your " + player.assholeDescript() + ".  ", false);

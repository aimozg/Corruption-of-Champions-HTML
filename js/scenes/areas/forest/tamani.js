...
TamaniScene.tamaniSexWon = function() {
    ...
    //Too big? Jerk off with feet and bukkake
        ...
        outputText(", so you grab her by the ankles and wrap her soft-soled feet about yourself.   You start jerking yourself off, using Tamani as a cute but expendable masturbation aid.  She chews a fingernail and massages her " + TamaniScene.tamaniChest() + " as she watches you, doing her best to put on a show.  The little slut seems to like it.<br><br>");
...
TamaniScene.tamaniSexLetHer = function() {
    ...
    if (inCombat()) {
        ...
        //Not taur
            ...
            outputText("  She wiggles her " + TamaniScene.tamaniChest() + ", and despite your efforts to control your body, ");
    ...
    //Not-taurs
        ...
        //(Doesnt fit)
            ...
            outputText("The dildo slips out of your abused " + player.assholeOrPussy() + " forgotten in the heat of your lovemaking, leaking pink goo.<br><br>");

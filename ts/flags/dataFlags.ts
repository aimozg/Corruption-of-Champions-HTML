...
const JOJO_TIMES_TALKED_WITH              = "Jojo_Times_Talked_With";
const JOJO_LAST_MEDITATION                = "Jojo_Last_Meditation";
const JOJO_TIMES_TRAINED_WITH             = "Jojo_Times_Trained_With";
const JOJO_RAPE_DISABLED                  = "Jojo_Rape_Disabled";
const JOJO_ANAL_XP                        = "Jojo_Anal_XP";
const JOJO_SEX_COUNTER                    = "Jojo_Sex_Counter";
const JOJO_ANAL_CATCH_COUNTER             = "Jojo_Anal_Catch_Counter";
const JOJO_VAGINAL_CATCH_COUNTER          = "Jojo_Vaginal_Catch_Counter";
const JOJO_LITTERS_AMILY_REACTION_COUNTER = "Jojo_Litters_Amily_Reaction_Counter";
const JOJO_LITTERS                        = "Jojo_Litters";
const JOJO_BLOWJOB_XP                     = "Jojo_Blowjob_XP";
//Marble
...
const BOW_SKILL                         = "Bow_Skill";
const KELT_NAKED_ALWAYS                 = "Kelt_Naked_On";
const KELT_BLOWJOBS_ON                  = "Kelt_Blowjobs_On";

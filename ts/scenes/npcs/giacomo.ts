...
namespace GiacomoScene {
	...
	function potionMenu():void {
		...
		//addButton(2, "Cerulean P.", pitchCeruleanPotion);
		addButton(4, "Back", giacomoEncounter);
	}
	...
	function buyCondom():void {
		if (player.gems < 2) {
			clearOutput();
			outputText("<br><br>Giacomo sighs, indicating you need " + num2Text(5 - player.gems) + " more gems to purchase this item.");
			doNext(eroticaMenu);
		}
		else {
			player.changeGems(-2);
	...
	function pitchDangerousPlantsBook():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.BookDangerousPlants)) {
	...
	function pitchTravellersGuide():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.BookTravelGuide)) {
	...
	function pitchHentaiComic():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.BookHentaiComic)) {
	...
	function pitchYogaGuide():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.BookYogaGuide)) {
	...
	function pitchDildo():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyDildo)) {
	...
	function pitchSelfStimulationBelt():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyStimBelt)) {
	...
	function pitchAllNaturalSelfStimulationBelt():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyANBelt)) {
		...
		if (player.hasKeyItem(KeyItems.BookDangerousPlants) && player.inte > 39) {
	...
	function pitchOnahole():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyOnahole)) {
	...
	function pitchDeluxeOnahole():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyDeluxeOnahole)) {
	...
	function pitchAllNaturalOnahole():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyANOnahole)) {
		...
		if (player.hasKeyItem(KeyItems.BookDangerousPlants) && player.inte > 35) {
	...
	function buyAllNaturalOnahole():void {
		...
		if (player.gems < 150) {
			...
			player.createKeyItem(KeyItems.ToyANOnahole, 0, 0, 0, 0);
		}
		doNext(eroticaMenu);
	...
	function pitchDualStimulationBelt():void {
		clearOutput();
		if (player.hasKeyItem(KeyItems.ToyDualBelt)) {
	...
	/*function nightSuccubiFirstTime() {
	 spriteSelect(8);
	 ...
	 function ceruleanSuccubusEncounterPart2() {
	 clearOutput();
	 spriteSelect(8);
	 if (player.gender == 1) {
	 ...
	 function ceruleanSuccubusEncounterPart3() {
	 clearOutput();
	 spriteSelect(8);
	 if (player.gender == 1) {
	 ...
	 function ceruleanSuccubusEncounterPart4() {
	 spriteSelect(8);
	 if (player.gender == 1) {
	 clearOutput();

	...
	export namespace Farm {
		...
		function workFarm(): void {
			...
			if (rand(4) == 0) {
				...
				player.changeLust(player.cowScore() + player.minotaurScore());
				...
				if (pepper <= 2) {
					...
					itype = randomChoice(Items.Consumables.CaninePepperLarge,Items.Consumables.CaninePepperDouble,Items.Consumables.CaninePepperBlack,Items.Consumables.CaninePepperKnotty,Items.Consumables.CaninePepperBulby);
				}

...
//Encounter the wanderer for the first time
    function wandererFirstMeeting () {
        ...
        addButton(4, "Leave", wandererLeave);
    }
//Repeated encounter if he left
    function wandererRepeatMeeting () {

...
// SCENES
//------------
namespace SandWitchScene {
    export let sandwitchPreg = new SandWitch();
    ...
    function allowSandWitchMagic():void {
        ...
        if (player.hairColor == "sandy blonde") {
            ...
            if (player.biggestLactation() > 0) {
                ...
                player.dynStats(["lib", 1], ["sens", 4], ["lust", 15]);
            }
            if (player.biggestLactation() == 0) {
                ...
                player.dynStats(["lib", .5], ["sens", 1], ["lust", 10]);
            }
    ...
    function sandWitchRape():void {
        ...
        if (player.lust >= player.maxLust()) {
            ...
            if (player.hairColor.indexOf("sandy blonde") != -1) {
                ...
                if (player.averageNipplesPerBreast() < 1) {
                    ...
                    for (let br of player.breastRows) {
                        //If that breast didnt have nipples reset length
                        br.nipplesPerBreast = 1;
                ...
                outputText("<br><br>The witch whispers into your ear, \"<i>I ALWAYS get what I want, dear...</i>\"");
            }
            else {
                outputText("The Sand Witch smiles wickedly and intones, \"<i>nuf erutuf rof riah ydnas, nus tresed eht sa ydnas.</i>\"<br><br>You feel a tingling in your scalp, and realize your hair has become a sandy blonde!");
                player.hairColor = "sandy blonde";
                outputText("<br><br>The witch whispers into your ear, \"<i>I ALWAYS get what I want, dear...</i>\"");
            }
            //RAEP
        ...
        //HP DEFEAT
            ...
            outputText("<br><b>You fall, defeated by the Sand Witch!</b><br><br>");
            cleanupAfterCombat();
            player.orgasm();
        }
    ...
    function beatSandWitch():void {
        clearOutput();
        if (monster.lust >= monster.maxLust()) outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and begins masturbating feverishly.  Sadly you realize your own needs have not been met.  Of course you could always fuck the horny witch...<br><br>Do you rape her?");
        else outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and struggles to rise.  Sadly you realize your own needs have not been met.  Of course, you could always fuck the witch...");
        ...
        menu();
        addButton(0, "Fuck Witch", sandWitchRaped, null, null, null, "TO BE ADDED");
        //if (player.hasKeyItem(KeyItems.   ) >= 0) {
        //    addButton(1, "Dildo Rape", sandWitchGetsDildoed, null, null, null, "TO BE ADDED");
        //}
        if (silly == true) {
            addButton(2, "Use 3i@-", missingOSex, null, null, null, "TO BE ADDED");
        }
        // Button 3
        ...
        if (player.gender > 0 && player.canOviposit()) {
            addButton(4, "Lay Eggs", ovipositSandWitches, null, null, null, "TO BE ADDED");
        }
        addButton(5, "Taunt Her", sandWitchSpanking, null, null, null, "TO BE ADDED");
    ...
    function sandWitchRaped():void {
        ...
        if (player.gender == 1 || player.gender == 3) {
            ...
            if (player.cor < 50) {
                ...
                outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose. Which do you go after?<br><br>");
                menu();
                addButton(0, "Breasts", sandWitchBewbs, null, null, null, "TO BE ADDED");
                addButton(1, "Sex", sandWitchSex, null, null, null, "TO BE ADDED");
                return;
            }
            //Really corrupt
            else {
        ...
        //Femfem
            ...
            outputText("You smile at the sand witch, trying to seem enticing. A tiny smile plays across her face even though she supports a worried frown. She reaches up to you, and you allow her to gently pull you down to her. You marvel at her multiple breasts, each perfectly rounded. Each has a nipple approximately two inches long, enough to suck if you wanted to.  ");
            outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose.<br><br>");
            sandWitchBewbs();
        }
    }
    // Taur rape intro
    ...
    function sandWitchCentaurBoning():void {
        ...
        if (player.cor < 70) {
            ...
            outputText("With a start you realize that the witch's orb is still inside you as it suddenly begins to pulse within your " + Appearance.assholeOrPussy(player) + ", causing you to cry out and hasten your pace across the dunes. ");
    ...
    function SWCentaurMore():void {
        ...
        //Grow tits
        if (player.biggestTitSize() == 0) {
            outputText("<br><br>(You grow a perfectly rounded pair of C-cup breasts!)");
            if (player.breastRows.length == 0) player.createBreastRow();
            player.breastRows[0].breasts      = 2;
            player.breastRows[0].breastRating = 3;
            if (player.breastRows[0].nipplesPerBreast < 1) player.breastRows[0].nipplesPerBreast = 1;
        ...
        //Grow tits bigger
        if (player.biggestTitSize() < 3) {
            outputText("<br><br>(Your breasts suddenly balloon outwards, stopping as they reach a perfectly rounded C-cup.)");
            player.breastRows[0].breastRating = 3;
            player.dynStats(["sens", 1], ["lust", 1]);
            return;
        }
        if (player.biggestLactation() == 0) {
            outputText("<br><br>(Your breasts now lactate.)");
            player.boostLactation(1);
            player.dynStats(["lib", .5], ["sens", 1], ["lust", 10]);
            return;
        }
        ...
        if (player.biggestLactation() < 3) {
            player.boostLactation(.7);
            outputText("<br><br>(Your breasts feel fuller... riper... milkier...)");
            return;
        }
        //Libido boost if nothing else
        player.dynStats("lib", 4);
        outputText("<br><br>(Your libido has been boosted significantly by the Sand Witch's magic.)");
        return;
    ...
    function sandWitchSex():void {
        ...
        outputText("<br><br>With a satisfied smirk, you lay atop your prize, your " + player.cockDescript(0) + " still twitching within her depths. One of the sand witch's hands rubs at your head, teasing your " + player.skinDesc + ". Like a fresh youth, you fall asleep, " + player.cockDescript(0) + " buried deep in the sand witch.  ");
    ...
    function knotSandWitch():void {
        ...
        outputText("You begin to buck into her at a frenzied pace, your body's need to release your motivation.  At first, your knot swelling is an extra sensation, a tightness that squeezes deliciously as more and more blood is forced inside by sheer stimulation.<br><br>");
        ...
        outputText("You grunt and push hard, desperate to force the bulbous cock-flesh inside, and you're rewarded as it pops in with a wet squelch. The tightening pressure around the base of your " + player.cockDescript(0) + " pushes you over the edge, and the cum begins to shoot in her tight hole, with your " + player.cockDescript(0) + " trapped inside!<br><br>");
//ORGAZMO
    ...
    function missingOSex():void {
        ...
        outputText("Clearly, this bitch needs the dick. And you're just the ^&a*pion to give it to her. You lick your lips and drop to your @nees, taking hold of her le-s and forcibly spreading them apart. Looking down, you see that her body is quite ready for you, her exposed fuckhole pouted and moist. You cannot help but laugh a- the situation, the motions making your \" + player.multiCockDescript(0) + \" bounce in the open air as you co-vulse with laugh-er. Her res$$tance only serves to arouse you, making you savor that choice ass before you claim it for your own.<br><br>");

        outputText("You want to embarrass her further, complete her humiliation upon the sands she once thought to be her domain. You tear her robes into little shreds, exposing her four generously sized breasts. Your eyes follow her dri-^ling nipples, the pupils bouncing as they do. \"Wh-what are you going to do? Rape me?!\" cries the witch, her tone equal parts terrified and wishful. Her thighs attempt to close, though you're sure it's more t$ grind them together than any atte-pt at preserving her modesty. Leaning down, y-u open up to let your tongue lap at her swollen clit. She arches her back and moans, thrusting her hips towa-ds you as bes- she can.<br><br>");
        ...
        outputText("<br><br><b>Don't report this as a bug, okay dawg?</b>");
        menu();
    ...
    //    spriteSelect(50);
        ...
        outputText("\"@ @a@'t b@lie^e y_u j@st _rie_ th_t.\" s@e sa_s @?th a )_=f. \"Yo_'re @oi(g to g_t a_d in all s))ts o& u_c_mfo_table pla_es ^& yo_ ke-_p t@at u@.\"<br><br>");

        outputText("\"@_i@_...\" s_e says, ##o@%7g @t yo_ s_@_y. \"W_@ d_n't @o_ (ull b=c( an_ @r_ _h_@ a_@in....\"<br><br>");
...
//[Fuck this!]
    ...
    function missingOSex5():void {
        //spriteSelect(50);
        clearOutput();
        outputText("Yeah no, fuck this shit. Seriously. You grip your controller with a barely restrained fury, fighting the urge to throw it across the room in a fit. Taking a moment, you collect yourself, and test the game. Yep, totally unresponsive to your buttons now. Damn thing froze AGAIN.<br><br>");

        outputText("You sigh a defeated sigh and cut the power to your Super Fentendo. After removing your Corruption of Champions cartridge and inspecting it for damage, you flip it over and blow into the open end of it a few times. Crisp, clean blowing, from one end to the other. Thorough. Professional. These games should be proud to have you as their owner.<br><br>");

        outputText("You flip up the little plastic fedora on your Imp-head-shaped Fentendo, exposing the cartridge slot and giving it a looksee. No problems there, it seems. Just to be sure, you huff and puff and blow for dust. It's bad enough that this system only supports one game, AND you have to go out to the store and pick up a new copy of it every time the developer makes one or two tiny little changes to the game. But those crashes and terrible dialogue in the last scene? You'd think that some of the writers just weren't trying anymore.<br><br>");

        outputText("The system powers up with the usual blips and boops you'd expect from this 8-bit powerhouse. So far so good. The Corruption of Champions title screen pops up, heralded by a little pixelated imp eagerly waving at the player with both hands and something else that protrudes from his body. The CoC theme kicks up, and you smile to yourself. Goddamn if that theme isn't catchy as all getout. You're going to have it stuck in your head for the rest of the day, you wager, but at least you'll have something to hum while you masterbate.<br><br>");
    ...
    function missingOSex6():void {
        //spriteSelect(50);
        clearOutput();
        outputText("You successfully restore your game. Everything's intact. At least, you thought it was. You must have messed up the password somewhere along the line, but oddly enough, the only difference is the clock being set an hour ahead and a few extra gems and EXP in your pocket.<br><br>");
    ...
    function sandWitchGetsDildoed():void {
        ...
        player.dynStats("lust", (20 + player.lib / 5 + player.cor / 10));
        cleanupAfterCombat();
    }
    ...
    function sandWitchSpanking():void {
        ...
        if (player.hasPerk(PerkLib.FireLord) || player.hasPerk(PerkLib.Hellfire) || player.hasPerk(PerkLib.Dragonfire)) outputText(", breathing out a gout of flame in rage, but you can't even direct the blast properly like this.  All it does is melt some of the sand below into glass");
    ...
    function ovipositSandWitches():void {
        ...
        menu();
        addButton(0, "Foreplay", eggWitchForeplay, null, null, null, "TO BE ADDED");
        addButton(1, "Get Fucking", getToFuckingWithZeEggsInWitch, null, null, null, "TO BE ADDED");
    }
    function eggWitchForeplay():void {
        ...
        player.dynStats(["lust", 25], ["cor", -.35]);
...
//(Bee, non-horse:
        ...
        if (player.fertilizedEggs() > 0) {
            if (player.canOvipositBee()) {
                sandwitchPreg.knockUpForce(PregnancyType.BEE_EGGS, 192);
                sandwitchPreg.eventFill(INCUBATION_SAND_WITCH_EVENT);
            }
            else {
                sandwitchPreg.knockUpForce(PregnancyType.DRIDER_EGGS, 192);
                sandwitchPreg.eventFill(INCUBATION_SAND_WITCH_EVENT);
            }
        }
        player.dumpEggs();
...
//PC is everything else:
        ...
        doNext(sandWitchBirthsYourMonstrositites);
    }
...
//PC is everything else:
    ...
    function sandWitchBirthsYourMonstrositites():void {
        clearOutput();
        ...
        sandwitchPreg.knockUpForce(0, 0); //Clear Pregnancy
        doNext(Camp.returnToCampUseOneHour);
    ...
    export function witchBirfsSomeBees():void {
        ...
        sandwitchPreg.knockUpForce(); //Clear Pregnancy
        doNext(Camp.returnToCampUseOneHour);
    }
}
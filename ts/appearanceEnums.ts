...
const SKIN_TYPE_PLAIN           =   SkinType.PLAIN;
const SKIN_TYPE_FUR             =   SkinType.FUR;
const SKIN_TYPE_SCALES          =   SkinType.SCALES;
const SKIN_TYPE_GOO             =   SkinType.GOO;
const SKIN_TYPE_UNDEFINED       =   SkinType.UNDEFINED;

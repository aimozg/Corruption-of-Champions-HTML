function HairDye(dyeId: string, dyeColor: string): Item {
	let newItem           = new Item(dyeId, dyeColor + " Dye", "a vial of " + dyeColor + " hair dye", ITEM_TYPE_CONSUMABLE);
...
function SkinOil(oilId: string, oilColor: string): Item {
	let newItem           = new Item(oilId, oilColor + " Oil", "a bottle of " + oilColor + " oil", ITEM_TYPE_CONSUMABLE);
...
function BodyLotion(lotionId:string, lotionType:string, longAdj:string): Item {
	let newItem           = new Item(lotionId, lotionType + " Ltn", "a flask of " + lotionType + " lotion", ITEM_TYPE_CONSUMABLE);
